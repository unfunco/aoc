...
# selected: Rock defeats Scissors, Scissors defeats Paper,
# and Paper defeats Rock. If both players choose the same shape, the round
...
# single round is the score for the shape you selected (1 for Rock,
...
File.read("#{__dir__}/input/day02").lines do |line|
end
