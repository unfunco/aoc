...
puts File.read("#{__dir__}/input/day01").split(/\n{2}/).map { |elf|
...
# (with 24000 Calories), then the third Elf (with 11000 Calories), then the
# fifth Elf (with 10000 Calories). The sum of the Calories carried by these
